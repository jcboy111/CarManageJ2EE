...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-main">
      ...
      <ul class="layui-nav top_menu">
        ...
        <li class="layui-nav-item" pc>
          <a href="javascript:;">
            <img src="images/me.png" class="layui-circle" width="35" height="35">
            <cite>J.C.Boy</cite>
          </a>
  ...
  <div class="layui-side layui-bg-black">
    <div class="user-photo">
      <a class="img" title="我的头像" ><img src="images/me.png"></a>
      <p>你好！<span class="userName">J.C.Boy</span>, 欢迎登录</p>
    </div>
  ...
  <div class="layui-footer footer">
    <p>copyright @2017 J.C.Boy 更多模板：<a href="http://www.mycodes.net/" target="_blank">源码之家</a>　　<a onclick="donation()" class="layui-btn layui-btn-danger l·ayui-btn-small">捐赠作者</a></p>
  </div>
</div>

<!-- 锁屏 -->
<div class="admin-header-lock" id="lock-box" style="display: none;">
  <div class="admin-header-lock-img"><img src="images/me.png"/></div>
  <div class="admin-header-lock-name" id="lockUserName">J.C.Boy</div>
  <div class="input_btn">
